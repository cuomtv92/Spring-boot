...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<link href="./WELCOME TO ICSSE 2017_files/show_img.css"
		...
		<script
			src="./WELCOME TO ICSSE 2017_files/PagingContent.js.tải xuống"
			type="text/javascript"></script>
		<link rel="shortcut icon" type="image/png"
			href="http://icsse2017.hcmute.edu.vn/Resources/Imagephoto/logo.png">
			<link href="./WELCOME TO ICSSE 2017_files/lightbox.css"
				rel="stylesheet" type="text/css">
				<script
					src="./WELCOME TO ICSSE 2017_files/lightbox.min.js.tải xuống"
					type="text/javascript"></script>
			...
			<input type="hidden" name="RadScriptManager1_TSM"
				...
				value=""> <input type="hidden" name="__EVENTARGUMENT"
					id="__EVENTARGUMENT" value=""> <input type="hidden"
						...
						value="/wEPaA8FDzhkNDczZDA5Nzk1YTUwNxgBBR5fX0NvbnRyb2xzUmVxdWlyZVBvc3RCYWNrS2V5X18WAgURUmFkV2luZG93TWFuYWdlcjEFOmN0bDA2JHBvcnRsZXRfODAwODg2YTgtY2NiNS00MGRkLTgxM2EtMmMwMmFjMGQyZTkyJFJhZE1lbnWKiebrwQupLujq6eM9e6oHL+oWXw==">
		</div>
		...
		<link href="./WELCOME TO ICSSE 2017_files/main.css" rel="stylesheet">
			<link href="./WELCOME TO ICSSE 2017_files/mainPortlets.css"
				...
				<script language="javascript" type="text/javascript">
					...
					function OnSearch(query) {
						PSCPortal.Services.CMS.SearchAndPaging(query,
								currentPage, OnSearchSuccess, OnSearchFailed);
					}
																	...
																	<div class="slider-wrapper theme-default">
																		<div id="slider" class="nivoSlider"
																			...
																			<a href="http://icsse2017.hcmute.edu.vn/"
																				target="_blank" class="nivo-imageLink"
																				style="display: none;"> <img
																				src="./WELCOME TO ICSSE 2017_files/HNQT1.jpg"
																				title=""
																				style="height: 350px; width: 1000px; visibility: hidden; display: inline;"></a>

																			<img class="nivo-main-image"
																				src="./WELCOME TO ICSSE 2017_files/HNQT3.jpg"
																				style="display: inline; height: auto; width: 1000px;"><div
															...
															<div
																...
																<ul class="rmRootGroup rmHorizontal">
																	...
																	<li class="rmItem rmLast"><a
																		...
																		<li class="rmItem rmLast"><a
																		href="http://icsse2017.hcmute.edu.vn/edit"
																		class="rmLink rmRootLink"><span class="rmText">Editer</span></a></li>
																</ul>
																<input
																...
																<tr>
																	<td
																		...
																		<div style="text-align: center;">
																			<br> <strong><span
																					style="color: #0070c0;">WELCOME TO ICSSE
																						2017</span></strong>
																				...
																				&nbsp; <span style="font-size: 16px;">&nbsp;Systems
																					...
																					interrelationships among them. While systems
																					...
																					interdependence and interaction complexity. This
																				...
																				style="text-align: justify; font-size: 16px;"><br>
																					...
																					<br style="text-align: justify;"> <span
																						style="text-align: justify; font-size: 16px;">&nbsp;
																							...
																							international conference that will take place in
																							Ho Chi Minh City during July 21-23, 2017. This
																							event will provide a great opportunity for
																							scientists, engineers, and practitioners from all
																							over the world to present the latest system
																							design concepts, research results, developments
																							and applications, as well as to facilitate
																							interactions between scholars and practitioners.
																							ICSSE 2017 will feature plenary speeches in
																							emerging technology topics given by world
																							renowned scholars. The proceedings of ICSSE 2017
																							will be published by the IEEE with EI indexing.
																							In addition, selected high-quality papers will be
																							published by special issues of SCI-indexed
																							journals.</span>&nbsp;</span><br></span> <br> <strong>ICSSE
												...
												<div id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666"
													...
													<div>
														...
														<div class="truycap_ute">
															<p>
																Visit month: <span
																	id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label4">3,635</span>
															</p>
															<p class="line_footer"></p>
															<p>
																Visit total:<span
																	id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label1">7,113</span>
															</p>
														</div>
